...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        plugin.init = function () {
            ...
            var el = document.getElementById('img-upload');
            new Sortable(el, {
                animation: 150,
            });
        };
        ...
        let createContainer = function () {
            ...
            let $uploadedContainer = $('<div>', {class: 'uploaded', id: 'img-upload'}).appendTo($container),
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                // $a = $('<a>', {href: src, target: '_blank'}).appendTo($container),
